  ...
  return (
    <section className="relative overflow-hidden py-24">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="rounded-[42px] border border-white/20 bg-white/10 p-10 backdrop-blur-xl lg:p-14">
            ...
            <div className="rounded-[32px] bg-white p-8 shadow-[0_25px_70px_rgba(0,0,0,.18)]">
              ...
              <div className="mt-8 space-y-4">
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-3 rounded-full bg-gradient-to-r from-[#008F5D] to-[#00B67A] px-6 py-4 font-semibold text-white transition hover:scale-105"
                >
